 ...
 */
public class CustomVertxFactoryTest {
    ...
    public static class TestVertxFactory implements VertxFactory {

        @Override
        public Vertx create() {
            return new TestVertxWrapper();
        }
    }

    private static class TestVertxWrapper implements Vertx {
        private final Vertx delegate;

        TestVertxWrapper() {
            this.delegate = Vertx.vertx();
        }
