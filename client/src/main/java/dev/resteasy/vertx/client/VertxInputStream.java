 ...
 */
class VertxInputStream extends InputStream {
     ...
     */
    VertxInputStream(final ReadStream<Buffer> stream) {
     ...
     */
    VertxInputStream(final ReadStream<Buffer> stream, final long maxPendingSize) {
        this.stream = stream;
