...
/**
 * Tests that {@code @Inject}-ed Vert.x context types remain accessible inside async callbacks ({@link CompletionStage}
 * and {@link AsyncResponse}).
 *
 * @author <a href="mailto:jperkins@ibm.com">James R. Perkins</a>
 */
@RestBootstrap(value = CdiAsyncContextInjectionTest.AsyncContextResource.class)
class CdiAsyncContextInjectionTest {
